...
- S06 contact foundation is implemented with owner-confirmed phone, hours, service area, and policies. The address and mapping action await S16.
- S16 is blocked until the owner supplies a public address/map destination, Google and review-profile URLs, and authentic permissioned shop, team, and project imagery. Credentials and insurance relationships are not currently offered but may be added later.
...
- S10 trust foundation is implemented; S16 will replace its temporary imagery and pending proof states when authentic permissioned assets and review approvals are supplied. Credentials and insurance relationships are not currently offered; experience, warranties, payment methods (cash and credit card), English/Spanish service, and the supplied logo are owner-confirmed.
