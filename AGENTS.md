...
- S05 body and collision journey is implemented with approved services, inspection expectations, and no-insurance-relationship guidance.
- S06 is blocked until the owner supplies an address, customer guidance, and mapping destination. Phone `502 644 0360`, regular hours Monday-Friday 9:00 AM-5:00 PM, service area, and the listed services are owner-confirmed.
- Address, Google Business Profile, review profiles, and real imagery remain pending owner confirmation. Credentials and insurance relationships are not currently offered but may be added later. Phone, regular hours, service area, listed services, policies, selected trust facts, controlled domain, content maintenance ownership, and the supplied logo are owner-confirmed.
...
- S10 keeps About and Gallery in accessible pending states until authentic, permissioned projects, image rights, and review approvals are supplied. Credentials and insurance relationships are not currently offered; experience, warranties, payment methods (cash and credit card), English/Spanish service, and the supplied logo are owner-confirmed.
